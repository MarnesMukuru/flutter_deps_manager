...
```bash
curl -fsSL https://github.com/MarnesMukuru/flutter_deps_manager/releases/download/v1.1.8/install.sh | bash
```
...
FLUTTER_DEPS_INSTALL_DIR=~/.local curl -fsSL https://github.com/MarnesMukuru/flutter_deps_manager/releases/download/v1.1.8/install.sh | bash

# Using wget
wget -qO- https://github.com/MarnesMukuru/flutter_deps_manager/releases/download/v1.1.8/install.sh | bash

# Manual download
wget https://github.com/MarnesMukuru/flutter_deps_manager/releases/latest/download/flutter-deps-upgrade-1.1.8.tar.gz
tar -xzf flutter-deps-upgrade-1.1.8.tar.gz && cd flutter-deps-upgrade-1.1.8
...
- **Latest**: [Download tar.gz](https://github.com/MarnesMukuru/flutter_deps_manager/releases/latest/download/flutter-deps-upgrade-1.1.8.tar.gz)
