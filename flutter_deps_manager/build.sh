...
generate_web_installer() {
    print_header "🌐 Generating Web Installer Script"
...
EOF
    ...
    print_success "✅ Web installer created at $installer_script"
    print_info ""
    print_info "Users can install with:"
    print_info "  curl -fsSL https://your-domain.com/install.sh | bash"
    print_info "  or"
    print_info "  wget -qO- https://your-domain.com/install.sh | bash"
}
